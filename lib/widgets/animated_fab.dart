...
class _AnimatedFabState extends State<AnimatedFab>
  ...
  void initState() {
    ...
    _colorAnimation = new ColorTween(begin: Colors.orange, end: Colors.orange[300])
        ...
        builder: (BuildContext context, Widget child) {
          return new Stack(
            ...
            children: <Widget>[
              ...
              _buildOption(Icons.thumb_up, 0.0),
              _buildOption(Icons.event_note, -math.pi / 3),
//              _buildOption(Icons.access_time, -2 * math.pi / 3),
             // _buildOption(Icons.person_add, math.pi),
              _buildOption(Icons.person_add, -2 * math.pi / 3),
              _buildFabCore(),
            ],
          );
        },
